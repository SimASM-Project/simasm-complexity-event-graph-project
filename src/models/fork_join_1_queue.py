...
class ForkJoin1Queue(Sandbox):
    def __init__(self, seed=0, code="ForkJoin1Queue", capacity=5, iat_mean=1.25, ist_mean=1.0):
    ...
    def _update_areas(self):
        ...
        if self._last_event_time is not None:
            ...
            if dt > 0:
                self._area_queue_total += (self.queue_count_1) * dt
