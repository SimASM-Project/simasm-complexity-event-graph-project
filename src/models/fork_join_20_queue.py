...
class ForkJoin20Queue(Sandbox):
    def __init__(self, seed=0, code="ForkJoin20Queue", capacity=5, iat_mean=1.25, ist_mean=1.0):
    ...
    def join(self):
        self._update_areas()
        if self.part_1_num > 0 and self.part_2_num > 0 and self.part_3_num > 0 and self.part_4_num > 0 and self.part_5_num > 0 and self.part_6_num > 0 and self.part_7_num > 0 and self.part_8_num > 0 and self.part_9_num > 0 and self.part_10_num > 0 and self.part_11_num > 0 and self.part_12_num > 0 and self.part_13_num > 0 and self.part_14_num > 0 and self.part_15_num > 0 and self.part_16_num > 0 and self.part_17_num > 0 and self.part_18_num > 0 and self.part_19_num > 0 and self.part_20_num > 0:
            self.part_1_num -= 1
            self.part_2_num -= 1
            self.part_3_num -= 1
            self.part_4_num -= 1
