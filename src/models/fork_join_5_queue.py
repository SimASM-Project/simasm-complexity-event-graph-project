...
class ForkJoin5Queue(Sandbox):
    def __init__(self, seed=0, code="ForkJoin5Queue", capacity=5, iat_mean=1.25, ist_mean=1.0):
    ...
    def join(self):
        self._update_areas()
        if self.part_1_num > 0 and self.part_2_num > 0 and self.part_3_num > 0 and self.part_4_num > 0 and self.part_5_num > 0:
            self.part_1_num -= 1
            self.part_2_num -= 1
            self.part_3_num -= 1
            self.part_4_num -= 1
